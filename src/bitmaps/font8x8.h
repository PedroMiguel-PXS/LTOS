// font8x8.h - Complete 8x8 bitmap font for LTOS
...
static unsigned char font8x8[128][8] = {
    ...
    // --- Printable ASCII starts at 0x20 (space) ---
    ...
    ['&']  = {0x00, 0x30, 0x48, 0x30, 0x72, 0x44, 0x3A, 0x00},
    ...
    ['b']  = {0x00, 0x40, 0x7C, 0x42, 0x42, 0x42, 0x7C, 0x00},
    ['c']  = {0x00, 0x00, 0x3C, 0x40, 0x40, 0x40, 0x3C, 0x00},
    ['d']  = {0x00, 0x02, 0x3E, 0x42, 0x42, 0x42, 0x3E, 0x00},
    ['e']  = {0x00, 0x00, 0x3C, 0x42, 0x7E, 0x40, 0x3C, 0x00},
    ['f']  = {0x00, 0x0C, 0x10, 0x3C, 0x10, 0x10, 0x10, 0x00},
    ['g']  = {0x00, 0x3E, 0x42, 0x42, 0x3E, 0x02, 0x3C, 0x00},
    ['h']  = {0x00, 0x40, 0x7C, 0x42, 0x42, 0x42, 0x42, 0x00},
    ['i']  = {0x00, 0x08, 0x00, 0x18, 0x08, 0x08, 0x1C, 0x00},
    ['j']  = {0x00, 0x02, 0x00, 0x02, 0x02, 0x42, 0x3C, 0x00},
    ...
    ['t']  = {0x00, 0x10, 0x7C, 0x10, 0x10, 0x10, 0x0C, 0x00},
    ...
    ['}']  = {0x00, 0x70, 0x08, 0x0C, 0x08, 0x08, 0x70, 0x00},
